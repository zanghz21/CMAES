...
#     python env_search/iterative_update/envs/online_env_new.py

# singularity exec ${SINGULARITY_OPTS} ../singularity/ubuntu_onlineGGO.sif \
    # python env_search/iterative_update/envs/env.py

singularity exec ${SINGULARITY_OPTS} ../singularity/ubuntu_onlineGGO.sif \
    python env_search/iterative_update/envs/online_env.py